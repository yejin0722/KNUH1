...
### 메인 페이지 
본 프로젝트는 강원대학교병원 공식 홈페이지의 UI/UX를 개선하고, 사용성과 접근성을 고려해 전면 리뉴얼한 웹사이트입니다.
기존 사이트는 구형 브라우저(IE11)에 최적화되어 있어 디자인 노후화, 낮은 가독성, 모바일 대응 미흡 등의 문제를 안고 있었습니다. 이에 따라 현대적인 인터페이스, 명확한 정보 구조, 반응형 구현을 목표로 리디자인을 진행하였습니다.

### 서브 페이지

- **주요 이용자**: 진료 예약 및 증명서 발급이 필요한 일반 국민
